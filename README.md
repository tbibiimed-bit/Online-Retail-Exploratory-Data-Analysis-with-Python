...
git clone https://github.com/tbibiimed-bit/Online-Retail-Exploratory-Data-Analysis-with-Python.git
...
|__ Online_Retail_Dashboard.pptx            # Dashboard (power-point version)
``` 
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
